...
function CreateProfessionalAccount() {
  ...
  return (
    ...
    <MainBox>
      ...
      { currentActiveForm === 3 ? <ProfessionalForm3 handleNextClick={handleNextClick} /> : null }
      { currentActiveForm === 4 ? <ProfessionalForm4 handleNextClick={handleNextClick} /> : null }
      { currentActiveForm === 5 ? <ProfessionalForm5 handleNextClick={handleNextClick} /> : null }
      { currentActiveForm === 6 ? <ProfessionalForm6 handleNextClick={handleNextClick} /> : null }
      { currentActiveForm === 7 ? <ProfessionalForm7 handleNextClick={handleNextClick} /> : null }
      { currentActiveForm === 8 ? <ProfessionalForm8 handleNextClick={handleNextClick} /> : null }
      { currentActiveForm === 9 && !isAccountVerified ? <UnverifiedAccountForm /> : null }
      { currentActiveForm === 9 && isAccountVerified ? <ProfessionalForm9 handleNextClick={handleNextClick} /> : null }
      { currentActiveForm === 10 ? <ProfessionalForm10 handleNextClick={handleNextClick} /> : null }
      { currentActiveForm === 11 ? <VerifyPaymentForm1 handleNextClick={handleNextClick} /> : null }
