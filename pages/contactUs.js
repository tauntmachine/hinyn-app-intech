...
import { EmailIcon, ImageIcon, LocationIcon, TelephoneIcon } from '../components/shared/Icon';
    ...
    <BGBox>
      <Container maxWidth="xl">
        <Grid container>
          <Grid item xs={6}>
            <Column>
              <Text color="red"><b>CONTACT US</b></Text>
              <Title>We&apos;re <span class="red">excited</span> to <br/>hear from you!</Title>
              <Box maxWidth="sm">
                <Subtitle>Hey there! We&apos;d love to hear from you - go ahead and fill out our form, and we promise to get back to you within 24 hours</Subtitle>
              </Box>
              ...
              <Column sx={{marginTop:'2.5rem',gap:'3rem'}}>
                { contactDetails && contactDetails.map((item,idx)=>{
                  return <Row key={'project-desc-'+idx} sx={{gap:'1rem',alignItems:'center'}} maxWidth="sm">
                      <Text sx={{fontSize:'25px !important'}}>
                        {idx === 0 
                        ? <EmailIcon variant="red" /> 
                        : (idx === 1 ? <LocationIcon variant="red" /> 
          ...
          <Grid item xs={5}>
            <Row sx={{background:'#ffffff',borderRadius:'12px',border:'1px solid #D8D8D8'}}>
                <ContactUsForm />
            </Row>
          </Grid>
        </Grid>
