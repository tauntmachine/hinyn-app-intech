...
const Item = styled.div`
  ...
  &:hover{
    ...
    border: ${props => props.type==="client" ? "1px solid #EB4C60" : "1px solid #4AA398"};
        ...
        <BackIcon variant="red" />
          ...
          <FormContainer>
            ...
            <Box component="form" noValidate onSubmit={submitHandler} sx={{ mt: 3, width:'100%'}}>
                ...
                <Grid item xs={12}>
                  <Item onClick={()=>createAccount('client')} type="client"> 
                    ...
                    <Box sx={{display:"flex",flexDirection:"column"}}>
                      <Text className='title'><b>Client</b></Text>
              ...
              <Grid container spacing={2} sx={{marginBottom:'2rem'}}>
                <Grid item xs={12}>
                  <Item onClick={()=>createAccount('professional')} type="professional"> 
                    <PhotoIcon variant="green" fontSize={'2.5rem'}/>
                    <Box sx={{display:"flex",flexDirection:"column"}}>
                      <Text className='title'><b>Professional</b></Text>
