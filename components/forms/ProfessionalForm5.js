...
function ProfessionalForm5({handleNextClick}){
  ...
  const handleClose = () => {
    ...
    function submitHandler(event){
        ...
        console.log('the selected', selectedLocation)
      ...
      <>
        <Container maxWidth="sm" sx={{marginBottom:"2rem",marginTop:"5rem"}}>
          ...
          <FormContainer>
            ...
            <Typography component="p" align="center">
            Please use your real address as this will be used for identity verification. <br/>Only your city and country will be shown publicly.
            </Typography>
            <Box component="form" noValidate onSubmit={submitHandler} sx={{ mt: 3, width:"100%"}}>
              <Grid container spacing={2} sx={{marginBottom:"2rem"}}>
                ...
                <Autocomplete
                  ...
                  sx={{ width: 'inherit' }}
                  renderInput={(params) => <StyledTextField {...params} label="Location" />}
                  onChange={event => {
