...
import { CssBaseline, TextField, Grid, Box, Container,TextareaAutosize} from '@mui/material';
...
function ContactUsForm(){
  ...
  const handleClose = () => {
    ...
    const submitHandler = (event) => {
        ...
        if(enteredEmail && isValid.email && enteredFullname && formMessage && mobileNumber){
            isValid.form = true; 
        }
