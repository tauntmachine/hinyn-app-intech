        ...
        <Container maxWidth="md" sx={{marginBottom:"2rem",marginTop:"5rem"}}>
          <CssBaseline />
            ...
            <Typography component="p" align="center">
              Your payment method is used to verify your identity and helps build trust.
            </Typography>
            <VerticalDivider/>
            <Box component="form" noValidate onSubmit={submitHandler} sx={{ mt: 3, width:"100%"}}>
              <Grid container spacing={2} sx={{marginBottom:"2rem"}}>
                <Grid item xs={12}>
                  <TitleContainer>
                    ...
                    <span><i>All major cards are accepted.</i></span>
                  </TitleContainer>
                  <CardContainer>
                      <Card1>
                        ...
                        <Box sx={{display:'flex',gap:'1rem', alignItems:'center'}} maxWidth="50%">
                          <SquareTextField
                            required
                            fullWidth
                            id="monthValidity"
                          ...
                          <Typography component="span" align="center" sx={{color:'#ACCECA',fontSize:'2rem'}}>
                            /
                          </Typography>
                          <SquareTextField
                            required
                      ...
                      <BlackDivider />
                      <span>CVV</span>
                        <Box sx={{display:'flex',gap:'1rem', alignItems:'center'}} maxWidth="30%">
                          <SquareTextField
                            required
                            fullWidth
                            id="cvvNumber"
              ...
              <Typography component="p" align="center">
                By clicking on verify, you agree to authorize the use of your card for future payments
              </Typography>
              <StyledButton>
